...
async def lego(event):
 ...
 try:
    ...
    img.save(fname2, "png")
    await tbot.send_file(event.chat_id, fname2, caption="Made By @KyoukoHori_00bot")
    if os.path.exists(fname2):
            os.remove(fname2)
 except Exception as e:
   await event.reply(f'Error Go to Help From  @Th30utlaw, {e}')
...
async def lego(event):
 ...
 try:
    ...
    fname2 = "EzilaXBotVLogo.png"
    img.save(fname2, "png")
    await tbot.send_file(event.chat_id, fname2, caption="@KyoukoHori_00bot")
    if os.path.exists(fname2):
            os.remove(fname2)
 except Exception as e:
   await event.reply(f'Error Go to Help From  @Th30utlaw, {e}')
