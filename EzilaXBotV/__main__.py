...
buttons = [
    [
        InlineKeyboardButton(
            text="📜Source", url="https://github.com/Th30utlaw/Hori-San"
        ),
        InlineKeyboardButton(
            text="❔ Help", url="http://t.me/KyoukoHori_00bot?start=help"
        ),
    ],
    [
        InlineKeyboardButton(
            text="➕ Add Hori-San to your group ➕",
            url="t.me/KyoukoHori_00bot?startgroup=true",
        ),
    ],
]

EZILAX_IMG = "https://telegra.ph/file/10f8a0d0be5a66d5d7490.jpg"

HELP_STRINGS = f"""
*Main Commands :* [🤖](https://telegra.ph/file/10f8a0d0be5a66d5d7490.jpg)
...
But Donate Aint Available right now  """
...
def AnkiVector_about_callback(update, context):
    ...
    if query.data == "aboutmanu_":
        query.message.edit_text(
            text=f"* Hi There  The name's {dispatcher.bot.first_name} \n\nAs  You I'm a next generational group management bot developed by Th30utlaw.* "
